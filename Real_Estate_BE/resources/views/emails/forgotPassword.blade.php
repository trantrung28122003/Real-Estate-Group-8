                                                                        ...
                                                                        <td style="padding:0px 30px 0px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content">
                                                                            <div>
                                                                                <div style=" text-align: center">
                                                                                    <span style="font-weight: 600; font-size: 20px; line-height: 27px;"> Thay đổi mật khẩu </span>
                                                                                </div>
                                                                                <div></div>
                                                                            </div>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content">
                                                                            <div>
                                                                                <div style=" text-align: center">
                                                                                    <span
                                                                                        style="font-size: 14px">Nếu bạn quên mất mật khẩu hoặc muốn thay đổi mật khẩu,</span><span
                                                                                        style="color: #000000; font-size: 18px; font-family: arial, helvetica, sans-serif"></span><span
                                                                                        style="font-size: 18px"></span>
                                                                                </div>
                                                                                <div style=" text-align: center">
                                                                                    <span
                                                                                        style="font-size: 14px">sử dụng link bên dưới để bắt đầu.</span><span
                                                                                        style="color: #000000; font-size: 18px; font-family: arial, helvetica, sans-serif"></span><span
                                                                                        style="font-size: 18px"></span>
                                                                                </div>
                                                                                <div></div>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="center" class="inner-td" style="border-radius:6px; font-size:16px; text-align:center;">
                                                                                            <a class="button_email"
                                                                                                ...
                                                                                                target="_blank"> Thay đổi mật khẩu </a>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
